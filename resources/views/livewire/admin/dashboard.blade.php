<div class="relative min-h-screen pb-12 overflow-x-hidden select-none" style="touch-action: pan-y;">
    ...
    <div class="flex flex-col gap-4 mb-6">
        <!-- Revenue Terminal -->
        <div class="liquid-glass rounded-2xl p-4 glass-highlight relative overflow-hidden h-[320px] md:h-[400px]">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <div class="lg:col-span-1 liquid-glass rounded-2xl p-5 glass-highlight flex flex-col h-[260px]">
        ...
        <div class="lg:col-span-2 liquid-glass rounded-2xl overflow-hidden glass-highlight h-[260px]">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-wrap gap-1">
                                        @foreach($rental->units as $u)
                                            <span class="px-1.5 py-0.5 rounded bg-white/5 text-[8px] md:text-[10px] font-bold text-white border border-white/10 uppercase">{{ $u->seri }}</span>
                                        @endforeach
                                    </div>
                                </td>
                                <td class="px-6 py-4 font-semibold text-white uppercase">{{ explode(' ', trim($rental->nama))[0] }}</td>

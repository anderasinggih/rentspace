        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-2 sm:gap-4">
                <a href="/" wire:navigate
                    class="hidden sm:inline-flex items-center px-3 py-1.5 rounded-md text-xs font-medium bg-secondary text-secondary-foreground hover:bg-secondary/80 transition-colors">
                    Lihat Web Publik ↗
                </a>

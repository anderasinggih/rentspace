<nav x-data="{ 
...
}" class="sticky top-0 z-[100] border-b border-white/10 shadow-sm" 
    style="background: rgba(0,0,0,0.4); backdrop-filter: blur(30px); -webkit-backdrop-filter: blur(30px);">
    ...
    <div x-show="adminMenuOpen" x-transition x-cloak style="display: none;"
        class="md:hidden absolute top-[115%] left-0 right-0 p-3 border border-white/10 border-t-white/20 shadow-2xl rounded-3xl mx-4 overflow-hidden flex flex-col gap-1 z-[110]"
        style="background: rgba(0,0,0,0.8); backdrop-filter: blur(40px); -webkit-backdrop-filter: blur(40px);">

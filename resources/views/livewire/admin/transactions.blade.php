                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        @elseif($trx->status === 'paid')
                                                                                                                                                                                                                                                            @if(in_array(auth()->user()->role, ['admin', 'staff']))
                                                                                                                                                                                                                                                                <x-ui.button wire:click.stop="handover({{ $trx->id }})"
                                                                                                                                                                                                                                                                    wire:confirm="Serah terima unit sekarang?"
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    @if(in_array(auth()->user()->role, ['admin', 'staff']))
                                                                                                                                                                                                                                                                                                                                        @if($inspectTrx->status === 'pending')
                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                         @elseif($inspectTrx->status === "paid")
                                                                                                                                                                                                                                                                                                                                             <x-ui.button wire:click="handover({{ $inspectTrx->id }})" wire:confirm="Serah terima unit?" variant="primary" size="sm" class="px-8 shadow-lg shadow-primary/20">Validasi Ambil Unit</x-ui.button>

    ...
    <main class="flex-1 w-full">
        ...
        <section x-data="{ 
            ...
            <div class="relative z-30 w-full flex flex-col items-center text-center px-4 sm:px-6 lg:px-8 cursor-default">
                ...
                @endif
                <div
                    class="inline-flex items-center rounded-full border-t border-l border-white/40 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white px-4 py-1.5 text-xs font-semibold mb-8 cursor-default tracking-widest uppercase transition-all duration-700 shadow-[inset_0_1px_1px_rgba(255,255,255,0.3)]"
                ...
                <div
                    ...
                    <a href="{{ route('public.booking') }}" wire:navigate
                        class="group/btn relative w-full sm:w-auto inline-flex items-center justify-center rounded-xl font-bold transition-all bg-white/10 dark:bg-white/5 backdrop-blur-sm backdrop-saturate-[180%] backdrop-contrast-[110%] border-t border-l border-white/50 border-r border-b border-white/20 text-foreground shadow-[0_8px_32px_rgba(255,255,255,0.05)] hover:scale-[1.05] active:scale-95 min-w-0 sm:min-w-[200px] h-12 px-2 sm:px-8 py-2 text-xs sm:text-base whitespace-nowrap overflow-hidden z-30">
                    ...
                    <a href="https://wa.me/{{ \App\Models\Setting::getVal('admin_wa', '6281234567890') }}"
                        ...
                        class="group/wa relative w-full sm:w-auto inline-flex items-center justify-center rounded-xl font-bold transition-all bg-zinc-950/20 dark:bg-white/5 backdrop-blur-sm backdrop-saturate-[180%] backdrop-contrast-[110%] border-t border-l border-white/30 border-r border-b border-zinc-950/10 text-foreground hover:scale-[1.05] active:scale-95 min-w-0 sm:min-w-[200px] h-12 px-2 sm:px-8 py-2 text-xs sm:text-base whitespace-nowrap overflow-hidden z-30">
                        <!-- Liquid Shine Overlay -->
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 -mt-16 sm:-mt-20 mb-10">
            <div class="grid grid-cols-3 divide-x divide-white/10 bg-white/[0.06] dark:bg-white/[0.02] backdrop-blur-sm border-t border-l border-white/20 shadow-2xl rounded-2xl sm:rounded-3xl overflow-hidden py-0 relative group/stats">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                                @foreach($units as $unit)
                                    ...
                                    <div
                                        ...
                                        class="group relative bg-blue-500/[0.03] dark:bg-blue-500/[0.02] backdrop-blur-sm border-t border-l border-blue-500/40 rounded-2xl p-3 shadow-xl hover:border-blue-500/60 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 ease-out flex-col justify-between overflow-hidden">

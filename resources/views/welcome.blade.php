...
<head>
    ...
    <script>
        (function() {
            ...
            if (darkMode === 'true' || (!('darkMode' in localStorage) && window.matchMedia('(prefers-color-scheme: dark)').matches)) {
    ...
    <main class="flex-1 w-full">
        ...
        <section x-data="{ 
            ...
            <div class="relative z-30 w-full flex flex-col items-center text-center px-4 sm:px-6 lg:px-8 cursor-default" x-data="{ spotlight: false }" @mouseenter="spotlight = true" @mouseleave="spotlight = false">
                ...
                <h1 @mouseenter="spotlight = true; window.hapticEngine && window.hapticEngine.trigger('light')" @mouseleave="spotlight = false"
                    data-haptic="light"
                ...
                <div
                    ...
                    <button @click="Livewire.dispatch('open-chat')"
                        data-haptic="medium"

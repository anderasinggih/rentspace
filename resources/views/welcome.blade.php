...
<body class="font-sans antialiased min-h-screen bg-background text-foreground flex flex-col">
    ...
    <main class="flex-1 w-full">
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 flex flex-col items-center text-center">
            <div
                class="inline-flex items-center rounded-full border px-4 py-1 text-sm font-medium transition-colors border-border bg-secondary text-secondary-foreground mb-8 cursor-default tracking-wide">
            ...
            <p class="mt-8 text-lg leading-8 text-muted-foreground max-w-2xl mx-auto">
                Pilihan terbaik untuk merasakan pengalaman menggunakan produk Apple original tanpa harus membeli baru.
                Proses cepat, stok terlihat transparan, dan langsung transaksi!
            </p>
            <div class="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('public.timeline') }}" wire:navigate
                    class="w-full sm:w-auto inline-flex items-center justify-center rounded-md font-medium transition-colors bg-primary text-primary-foreground shadow-md hover:bg-primary/90 h-11 px-8 py-2 text-base">
                    Lihat Jadwal
                </a>
            </div>
        </section>

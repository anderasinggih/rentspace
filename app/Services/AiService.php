...
class AiService
{
    ...
    {
        $dbKey = trim(\App\Models\Setting::getVal('chatbot_api_key') ?? '');
    ...
    public function getSystemContext()
    {
        ...
        $context .= "PENJUALAN: JANGAN menawarkan tombol [BOOKING] secara otomatis. Hanya berikan tag [BOOKING] jika user bertanya tentang cara booking, cara sewa, atau secara eksplisit meminta untuk melakukan pemesanan.\n\n";
